...
<div class="x-body">
  ...
  <div class="layui-tab layui-tab-brief">
    <ul class="layui-tab-title">
      <li class="layui-this"><a href="${pageContext.request.contextPath}/manager/download-book">心理书籍管理</a></li>
    </ul>
    <div class="layui-tab-content" >
      <div class="layui-tab-item layui-show">
        ...
        <table id="downloadlist" class="tablelist">
          <%--<thead>--%>
          <%--<tr>--%>
    ...
    <script>
      layui.use(['laydate','element','laypage','layer','table'], function(){
        ...
        table.render({
          ...
          cols:[[
            {type:'checkbox'},
            {field:'reportId',title:'报告编号'},
            {field:'uname',title:'病人姓名'},
            {field:'did',title:'医生姓名'},
            {field:'reportTime',title:'检查时间'},
            {field:'title',title:'主要病症'},
            {field:'section',title:'所属科室'},
            {field:'picture',title:'检查报告'}
          ]]
        });
      });
