...
<body>
<div class="x-nav"> <span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>网站信息管理</cite></a> <a><cite>关于我们</cite></a> </span> <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a> </div>
<div class="x-body">
  ...
  <div class="tools">
    <ul class="toolbar">
      ...
      <li onclick="about_us_add('添加用户','${pageContext.request.contextPath}/manager/about_us_add','600','500')"><span><img src="${pageContext.request.contextPath}/static/images/t01.png" /></span>添加</li>
    </ul>
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td>中心介绍</td>
      <td align="center"><img src="${pageContext.request.contextPath}/static/images/img1.jpg" width="100" alt=""></td>
      <td > 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 </td>
      <td class="td-status"><button class="sp">已显示</button></td>
      <td class="td-manage"><a title="修改" href="javascript:;" onclick="about_us_edit('修改','${pageContext.request.contextPath}/manager/about_us_edit','4','','510')"
    ...
    <tr>
      ...
      <td >文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 文字信息 </td>
      <td class="td-status"><button class="sp">已显示</button></td>
      <td class="td-manage"><a title="修改" href="javascript:;" onclick="about_us_edit('修改','/about_us_edit','4','','510')"
                               class="ml-5" style="text-decoration:none"> <i class="layui-icon">&#xe642;</i> </a> <a title="删除" href="javascript:;" onclick="banner_del(this,'1')"
                                                                                                                     style="text-decoration:none"> <i class="layui-icon">&#xe640;</i> </a></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>团队力量/咨询师介绍</td>
      <td align="center"><img src="${pageContext.request.contextPath}/static/images/t2.jpg" width="101" height="109"></td>
      <td > 咨询师一 </td>
      <td class="td-status"><button class="sp">已显示</button></td>
      <td class="td-manage"><a title="修改" href="javascript:;" onclick="about_us_edit('修改','/about_us_edit','4','','510')"
                               class="ml-5" style="text-decoration:none"> <i class="layui-icon">&#xe642;</i> </a> <a title="删除" href="javascript:;" onclick="banner_del(this,'1')"
