...
<div class="x-body">
  ...
  <div class="tools">
    <ul class="toolbar">
      ...
      <li onclick="role_management_add('添加用户','${pageContext.request.contextPath}/manager/role_management_add','900','500')"><span><img src="${pageContext.request.contextPath}/static/images/t01.png" /></span>添加</li>
      <li onclick="role_management_edit('编辑','${pageContext.request.contextPath}/manager/role_management_edit','900','500')"><span><img src="${pageContext.request.contextPath}/static/images/t02.png" /></span>编辑</li>
      <li><span><img src="${pageContext.request.contextPath}/static/images/t09.png" /></span>批量导出</li>
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td>12</td>
      <td >更改权利</td>
      <td class="td-manage"><a title="分配权限" href="javascript:;" onclick="role_management_permissions('分配权限','${pageContext.request.contextPath}/manager/role_management_permissions','4','','510')"
                               class="ml-5" style="text-decoration:none"> <i class="layui-icon"><img src="${pageContext.request.contextPath}/static/images/quanxian.png" width="15" height="15"></i> </a> <a title="查看" href="javascript:;" onclick="role_management_look('查看','${pageContext.request.contextPath}/manager/role_management_look','4','','510')"
