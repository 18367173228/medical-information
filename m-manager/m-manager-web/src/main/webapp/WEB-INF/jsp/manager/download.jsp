...
<div class="x-body">
  ...
  <div class="layui-tab layui-tab-brief">
    <ul class="layui-tab-title">
      <li class="layui-this"><a href="${pageContext.request.contextPath}/download">心理书籍管理</a></li>
    </ul>
    <div class="layui-tab-content" >
      <div class="layui-tab-item layui-show">
        ...
        <div class="tools">
          <ul class="toolbar">
            <li onclick="download_picadd('添加信息','${pageContext.request.contextPath}/manager/download_add','600','500')"><span><img src="${pageContext.request.contextPath}/static/images/t01.png" /></span>添加</li>
          </ul>
        ...
        <table class="tablelist">
          ...
          <tr>
            ...
            <td class="td-manage"><a title="修改" href="javascript:;" onclick="download_picedit('修改','${pageContext.request.contextPath}/manager/download_edit','4','','510')"
