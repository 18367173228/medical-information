...
<body>
<div class="x-nav"> <span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>数据管理</cite></a> <a><cite>预警信息管理</cite></a> </span> <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a> </div>
<div class="x-body">
  <table width="100%">
    <tr>
  ...
  <table class="tablelist">
    ...
    <tr>
      ...
      <td align="center"><img src="${pageContext.request.contextPath}/static/images/blu.jpg"></td>
      <td >没有症状</td>
    </tr>
    <tr>
      <td align="center">异常</td>
      <td align="center"><img src="${pageContext.request.contextPath}/static/images/red.jpg"></td>
      <td >需要预警</td>
    </tr>
    </tbody>
  </table>
